...
import usePostCreatePostFilter from '@/hooks/post/usePostCreatePostFilter'

const PostFilterCreatePage = () => {
  const navigate = useNavigate()
  const { mutate } = usePostCreatePostFilter()
...
export default PostFilterCreatePage
